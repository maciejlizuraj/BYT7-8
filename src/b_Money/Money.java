...
public class Money implements Comparable {
    ...
    public Boolean equals(Money other) {
        return currency.universalValue(amount).equals(other.currency.universalValue(other.amount));
    }
    ...
    public int compareTo(Object other) {
        ...
        return currency.universalValue(amount) - otherMoney.currency.universalValue(otherMoney.amount);
    }
}