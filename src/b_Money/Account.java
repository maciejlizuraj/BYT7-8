...
public class Account {
	 ...
	 */
	public void addTimedPayment(String id, Integer interval, Integer next, Money amount, Bank tobank, String toaccount) throws TimedPaymentExistsException, InvalidValueException {
		//Bug found by testTimedPayment2(). Lack of checking if id is already in use.
		valueValidityTest(amount);
	 ...
	 */
	public void tick() throws InvalidValueException {
		//Bug found by TestTimedPayment(). During one tick all payments ticked twice.
	 ...
	 */
	public void deposit(Money money) throws InvalidValueException {
		valueValidityTest(money);
	 ...
	 */
	public void withdraw(Money money) throws InvalidValueException {
		valueValidityTest(money);
	...
	private void valueValidityTest(Money money) throws InvalidValueException {
		if (money.universalValue()<=0){
	...
	private class TimedPayment {
		...
		TimedPayment(Integer interval, Integer next, Money amount, Account fromaccount, Bank tobank, String toaccount) throws InvalidValueException {
		...
		public Boolean tick() throws InvalidValueException {
			if (next == 0) {
				next = interval;
